...
CXI Jet Tracking could always use more documentation, whether
as part of the official CXI Jet Tracking docs, in docstrings,
...
3. The pull request should work for Python 3.5 or greater. Check
   https://travis-ci.org/pcdshub/jet_tracking/pull_requests
