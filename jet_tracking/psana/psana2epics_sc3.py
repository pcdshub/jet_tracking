...
def initArgs():
    ...
    parser.add_argument("--exp", type=str, default='cxix34517',
                        help='Experiment')
    parser.add_argument("--run", type=int,
                        help='Run')
    parser.add_argument("--instrument", type=str, default='cxi',
                        help='Instrument')
    parser.add_argument("--pvbase", type=str, default='CXI:SC3:DIFFRACT',
                        help='pvbase')
    parser.add_argument("--alias", type=str, default='DsdCsPad',
                        help='detector alias')
...
def output_cspad_sum(ds=None, alias='DsdCsPad',
                     pvbase='CXI:SC3:DIFFRACT', calc_period=True, calc_streak=False,
...
def output_cspad_streak(ds=None, alias='DsdCsPad',
                        pvbase='CXI:SC3:DIFFRACT', nevents=10, **kwargs):
    """
