...
class Controls_Ui(object):
    ...
    def setupUi(self, obj):
        ...
        #obj.layout_usr_cntrl.addWidget(self.lbl_usr_cntrl)
        ...
        obj.bttngrp1.addButton(self.rdbttn_live, id=1)
        obj.bttngrp1.addButton(self.rdbttn_sim, id=0)
        ...
        #obj.frame_samp.setLayout(self.layout_samp)
        #obj.layout_usr_cntrl.addWidget(self.frame_samp)
        ...
        obj.layout_usr_cntrl.addWidget(self.lbl_motor)
        ...
        obj.layout_motor.addLayout(self.layout_motor_manual)
        obj.layout_motor.addLayout(self.layout_motor_input)
        obj.layout_motor.addLayout(self.layout_motor_bttns)
        obj.layout_motor.addLayout(self.layout_tracking)
        obj.frame_motor.setLayout(self.layout_motor)
        obj.layout_usr_cntrl.addWidget(self.frame_motor)
        obj.layout_motor_manual.addWidget(self.rdbttn_manual)
        obj.layout_motor_manual.addWidget(self.rdbttn_auto)
        obj.layout_motor_input.addWidget(self.lbl_motor_ll, 0, 0)
        obj.layout_motor_input.addWidget(self.le_motor_ll, 0, 1)
        obj.layout_motor_input.addWidget(self.lbl_motor_hl, 0, 2)
        obj.layout_motor_input.addWidget(self.le_motor_hl, 0, 3)
        obj.layout_motor_input.addWidget(self.lbl_motor_size, 1, 0)
        obj.layout_motor_input.addWidget(self.le_size, 1, 1)
        obj.layout_motor_input.addWidget(self.lbl_motor_average, 1, 2)
        obj.layout_motor_input.addWidget(self.le_ave_motor, 1, 3)
        obj.layout_motor_input.addWidget(self.lbl_algorithm, 2, 0)
        obj.layout_motor_input.addWidget(self.cbox_algorithm, 2, 1)
        obj.layout_motor_bttns.addWidget(self.bttn_search)
        obj.layout_motor_bttns.addWidget(self.bttn_tracking)
        obj.layout_motor_bttns.addWidget(self.bttn_stop_motor)
        obj.layout_tracking.addWidget(self.lbl_tracking)
        obj.layout_tracking.addWidget(self.lbl_tracking_status)
        ...
        obj.frame_monitor_status.layout().addWidget(self.lbl_monitor)
        obj.frame_monitor_status.layout().addWidget(self.lbl_monitor_status)

        obj.frame_i0 = QFrame()
        obj.frame_i0.setLayout(QHBoxLayout())
        obj.frame_i0.layout().addWidget(self.lbl_i0)
        obj.frame_i0.layout().addWidget(self.lbl_i0_status)

        obj.frame_diff_i0 = QFrame()
        obj.frame_diff_i0.setLayout(QHBoxLayout())
        obj.frame_diff_i0.layout().addWidget(self.lbl_diff_i0)
        obj.frame_diff_i0.layout().addWidget(self.lbl_diff_status)

        obj.layout_usr_cntrl.addWidget(self.frame_monitor_status)
        obj.layout_usr_cntrl.addWidget(self.frame_i0)
        obj.layout_usr_cntrl.addWidget(self.frame_diff_i0)
        ###############################
        ...
        obj.layout_usr_cntrl.addWidget(self.text_area)
        ...
        obj.frame_jjbttns.layout().addWidget(self.bttn_calibrate)
        obj.frame_jjbttns.layout().addWidget(self.bttn_start)
        obj.frame_jjbttns.layout().addWidget(self.bttn_stop)

        obj.layout_usr_cntrl.addWidget(self.frame_jjbttns)
        ##############################
