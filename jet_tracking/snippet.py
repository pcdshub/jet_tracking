"""
Example python code to load and run jet tracking GUI from cxipython.
"""
...
jt_macros = {'PARAMS': 'CXI:SC1:INLINE', 'REQ': 'CXI:JTRK:REQ',
             'PASS': 'CXI:JTRK:PASS'}
...
# connect PVs -- because PyDM version in cxi3 is too old and does not
#                automatically connect PVs
